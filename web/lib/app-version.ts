...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    version: "v2.0.0",
    date: "2026-09-02",
    summary: "작업 바구니를 기본 입출고 처리 화면으로 정리했습니다.",
    items: [
      "상단 탭은 재고관리와 품종등록으로 단순화하고, 입출고 이력은 상단 배너에서 큰 팝업으로 열리도록 변경했습니다.",
      "검색 결과의 선택 버튼으로 품목을 바로 작업 바구니에 담고, 바구니에서 입고/사용, 수량, 정상품/B급, 메모를 조정하도록 정리했습니다.",
      "작업 날짜는 바구니 공통값으로 한 번만 입력하고, 입출고 이력은 100건 단위 페이지로 과거 기록까지 조회할 수 있게 했습니다.",
    ],
  },
  {
    version: "v1.8.0",
    date: "2026-09-02",
    summary: "여러 품목을 한 번에 입고 또는 사용 처리할 수 있는 작업 바구니를 추가했습니다.",
    items: [
      "기존 단건 입고/사용처리는 그대로 유지하고, 선택한 품목을 작업 바구니에 담아 순차 처리할 수 있게 했습니다.",
      "동일 품목과 동일 재고구분은 바구니에서 수량을 합치고, 정상품과 B급은 별도 행으로 관리합니다.",
      "작업 바구니 저장 전 확인, 정상품 사용 품목별 B급 재분류 선택, 성공/실패/미처리 결과 표시를 추가했습니다.",
    ],
  },
  {
    version: "v1.7.9",
    date: "2026-09-02",
    summary: "입고/사용처리 화면을 마우스와 터치로 더 쉽게 쓰도록 개선했습니다.",
    items: [
      "입고와 사용 선택 버튼, 품목 후보, 저장 버튼의 클릭 영역을 키워 현장 작업 흐름을 더 분명하게 정리했습니다.",
      "기존 수량 입력칸은 유지하면서 -5, -1, +1, +5 수량 조절 버튼을 추가했습니다.",
      "메모 입력칸은 유지하고 정기 입고, 교체 사용, 점검 사용, 재고 확인 빠른 입력 버튼을 추가했습니다.",
    ],
  },
  {
    version: "v1.7.8",
    ...
    items: [
      "입고 등록된 전체 품목 팝업에서 체크한 품목만 A4 QR 또는 바코드 라벨로 인쇄할 수 있게 했습니다.",
      "스캐너가 기존 바코드와 QR을 함께 읽도록 지원 포맷과 화면 문구를 정리했습니다.",
      "라벨에는 품목번호와 품명만 표시되도록 구성했습니다.",
    ],
  },
  {
    version: "v1.7.7",
